...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__renderResults__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__inputsRender__ = __webpack_require__(8);





Object(__WEBPACK_IMPORTED_MODULE_3__inputsRender__["a" /* default */])();
__WEBPACK_IMPORTED_MODULE_2__renderResults__["a" /* default */].createElements();
...
for(let i=0; i < operationsBtn.length; i++) {
    operationsBtn[i].addEventListener('click', (event) => {
        __WEBPACK_IMPORTED_MODULE_2__renderResults__["a" /* default */].clearResult();
        __WEBPACK_IMPORTED_MODULE_2__renderResults__["a" /* default */].renderResult(Object(__WEBPACK_IMPORTED_MODULE_1__math__["a" /* default */])(event.target.innerText)(parseInt(inputs[0].value), parseInt(inputs[1].value)));
    })
}
