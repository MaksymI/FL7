...
if (!game) {
    ...
    function winAmount (attempts) {
        switch (attempts) {
        case 2:
        win_amount += (win_base_1 * win_multiplayer);
        break;
        case 1:
        win_amount += (win_base_2 * win_multiplayer);
        break;
        case 0:
        win_amount += (win_base_3 * win_multiplayer);
        break;
        default:
        break;
        }
